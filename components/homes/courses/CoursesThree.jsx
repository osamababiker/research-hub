...
import { scholarshipCountry } from "../../../data/courses";
...
export default function CategoriesTwo() {
  ...
  useEffect(() => {
    ...
    if (country == "All") {
      ...
      filtered = coursesData.filter((elm) => elm.country == country);
    }


    setPageItems(filtered);
  }, [country, currentCategory]);
          ...
          <div className="col-lg-6">
            <div className="sectionTitle ">
              ...
              <p className="sectionTitle__text ">
                6.500+ unique Scholarships you can apply to
              </p>
            </div>
          </div>
                ...
                <div>
                  <div
                    className={`dropdown js-dropdown js-drop2-active ${
                      currentDropdown == "country" ? "-is-dd-active" : ""
                    }`}
                  >
                    <div
                      onClick={() =>
                    ...
                    <div
                      className={`toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-drop2-toggle ${
                        currentDropdown == "country" ? "-is-el-visible" : ""
                      } `}
                    >
                      <div className="text-14 y-gap-15 js-dropdown-list">
                        {scholarshipCountry.map((elm, i) => (
                          <div
                            key={i}
                            onClick={() => {
                              setCountry(elm);
